...
class EleroCover{
    ...
    constructor(adapter, transmitter, name, channel, supported_features){
    ...
    set_cover_position(position){
        ...
        this._adapter.log.warn("Elero - transmitter: '"+this._transmitter.get_serial_number()+"' ch: '"+this._channel+"' The set cover position function is not implemented yet.");
    }
    ...
    set_cover_tilt_position(tilt_position){
        ...
        this._adapter.log.warn("Elero - transmitter '" + this._transmitter.get_serial_number() + "' ch '" + this._channel + "' The set cover tilt position function is not implemented yet.");
    }
    ...
    set_states(){
        ...
        //INFO_BLOCKING,INFO_OVERHEATED,INFO_TIMEOUT
            ...
            this._tilt_position = null;
            this._state = elero.STATE_UNKNOWN;
            this._adapter.log.error("Elero - transmitter '"+this._transmitter.get_serial_number()+"' channel '"+this._channel+"' Error response '"+this._response['status']+"'.");
        //INFO_SWITCHING_DEVICE_SWITCHED_ON, INFO_SWITCHING_DEVICE_SWITCHED_OFF
            ...
            this._tilt_position = null;
            this._state = elero.STATE_UNKNOWN;
            this._adapter.log.error("Elero - transmitter '"+this._transmitter.get_serial_number()+"' channel '"+this._channel+"' Unhandled response '"+this._response['status']+"'.");
        }
    }
}
module.exports = { EleroCover };