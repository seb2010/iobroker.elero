		...
		serialport.list(function (err, ports) {
            ports.forEach(function (port) {
                ...
                if (DEFAULT_BRAND in port.manufacturer && DEFAULT_PRODUCT in port.product) {
                    ...
                    var elero_transmitter = new EleroTransmitter(port, baudrate, bytesize, parity, stopbits);
...
class EleroTransmitter{
    ...
    set_channel(channel, obj){
		...
		if(channel in this._learned_channels){
		    ...
		    this.log.debug("The '"+channel+"' channel is not taught to the '"+this._serial_number+"' transmitter.");
		    return false;
		}
	}
